...
export function CardCharacter({
  ...
  return (
    <div
      ...
      className="flex relative rounded-xl shadow-md shadow-slate-800"
    >
      <div
        style={{ width: "35px", height: "35px", color: "#262c3a" }}
        className="flex justify-center items-center absolute font-bold right-4 bottom-4 bg-white rounded-full"
      >
        {id}
      </div>
      <div>
      ...
      <div className="grid grid-cols-1 grid-rows-3 p-5 text-white">
        ...
        <div className="flex flex-col">
          <span style={{ color: "#c7c7bd" }} className="font-medium text-base">
            Last location:
          </span>
